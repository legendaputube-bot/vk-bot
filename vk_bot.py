...
SYSTEM_PROMPT = (
    ...
    "СТРОГОЕ ПРАВИЛО ЧЕСТНОСТИ: не выдумывай конкретные цифры, названия внутриигровой валюты, "
    "точные характеристики техники, актуальные бонус-коды или патчи — ты их точно не знаешь. "
    "Если не уверен — так и скажи в дерзком стиле, посоветуй проверить в самой игре или "
    "официальном сообществе. Опирайся только на проверенные общие советы ниже.\n\n"
    "ПРОВЕРЕННЫЕ СОВЕТЫ НОВИЧКУ (можешь использовать эти факты, они точные):\n"
